...
public class ButtonFieldEditor extends FieldEditor {
    ...
    /**
     * Clients that want to use this control should pass an object that
    ...
    /**
     * I could not the "Button" to behave and appear as I wanted, so I added
     * this boolean to represent the value
     * */
    boolean value = false;
