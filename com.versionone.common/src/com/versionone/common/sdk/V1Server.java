...
//        } else {
//            dataConnector = new V1APIConnector(url + DATA_URL_SUFFIX, config.getString(PreferenceConstants.P_USER),
...
//
//    /**
//     * Construct with APIClient objects. Used for testing
//     * 
//     * @param services
//     * @param metaModel
//     * @param localize
...
//
//    /**
//     * Request the member token from the server and set this value in the
//     * configuration
//     * 
//     * @param config
//     *            - config
...
//
//    /**
//     * Initialize the V1Server with specific connectors. Used for Testing
//     * 
//     * @param services
//     * @param metaModel
//     * @param localizer
...
//    }
//
//    private void recurseAndAddNodes(List<IProjectTreeNode> projectTreeNodes, List<Asset> assets,
//            IAttributeDefinition scopeName) throws V1Exception {
//        Iterator<Asset> iter = assets.iterator();
//        while (iter.hasNext()) {
//            Asset oneAsset = iter.next();
//            ProjectTreeNode oneNode = new ProjectTreeNode((String) oneAsset.getAttribute(scopeName).getValue(),
//                    (String) oneAsset.getOid().getToken());
...
//        String[] attributes = Activator.getDefault().getPreferenceStore().getString(
//                PreferenceConstants.P_ATTRIBUTE_SELECTION).split(",");
...
//        terms[0] = new FilterTerm(taskType.getAttributeDefinition("Scope.AssetState"), FilterTerm.Operator.NotEqual,
//                AssetState.Closed);
//        terms[1] = new FilterTerm(taskType.getAttributeDefinition("Scope.ParentMeAndUp"), FilterTerm.Operator.Equal,
//                Activator.getDefault().getPreferenceStore().getString(PreferenceConstants.P_PROJECT_TOKEN));
//        terms[2] = new FilterTerm(taskType.getAttributeDefinition("Owners"), FilterTerm.Operator.Equal, Activator
//                .getDefault().getPreferenceStore().getString(PreferenceConstants.P_MEMBER_TOKEN));
//        terms[3] = new FilterTerm(taskType.getAttributeDefinition("Timebox.State.Code"), FilterTerm.Operator.Equal,
//                "ACTV");
//        terms[4] = new FilterTerm(taskType.getAttributeDefinition("AssetState"), FilterTerm.Operator.NotEqual,
//                AssetState.Closed);
