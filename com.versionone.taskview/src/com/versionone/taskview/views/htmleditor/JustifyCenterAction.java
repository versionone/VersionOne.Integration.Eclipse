 ...
 * 
 */
public class JustifyCenterAction extends Action implements Listener{
    private HtmlComposer composer = null;

    public JustifyCenterAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifycenter.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.JUSTIFYCENTER, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.JUSTIFYCENTER);
    }
