 ...
 * 
 */
public class JustifyRightAction extends Action implements Listener{
    private HtmlComposer composer = null;

    public JustifyRightAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifyright.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.JUSTIFYRIGHT, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.JUSTIFYRIGHT);
    }
