 ...
 * 
 */
public class StrikeThroughAction extends Action implements Listener {

private HtmlComposer composer = null;
    
    public StrikeThroughAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/strikethrough.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.STRIKETHROUGH, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.STRIKETHROUGH);
    }
