 ...
 * 
 */
public class UndoAction extends Action implements Listener {
    
    private HtmlComposer composer = null;
    
    public UndoAction(HtmlComposer composer) {
        super("", IAction.AS_CHECK_BOX);
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("de.spiritlink.richhtml4eclipse", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/undo.gif"));
        this.composer = composer;
        this.composer.addListener(EventConstants.UNDO, this);
    }
    ...
    @Override
    public void run() {
        this.composer.execute(JavaScriptCommands.UNDO);
    }
